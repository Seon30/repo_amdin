...
<div class="content-wrapper">
	...
	<input id="c_date" value="<%=c_date%>" hidden="true">
		<input id="repo_name" value="<%=repo_name%>" hidden="true">
                                	...
                                	<div class="input-group input-group-lg mb-3">
 										<div class="input-group-prepend">              
											<select type="button" id="searchVal" class="form-control custom-select-lg">
			                                	<option value="1" selected="selected" >OS</option>
								...
								<div class="card">
									<div class="card-header d-flex p-0">
										...
										<ul class="nav nav-pills ml-auto p-2">
											<li class="nav-item" id="7OS"><a class="nav-link active" href="#OS" data-toggle="tab">7_OS</a></li>
											<li class="nav-item" id="7Extras"><a class="nav-link" href="#OS" data-toggle="tab">7_Extras</a></li>
											<li class="nav-item" id="7Plus"><a class="nav-link" href="#OS" data-toggle="tab">7_Plus</a></li>
											<li class="nav-item" id="7Updates"><a class="nav-link" href="#OS" data-toggle="tab">7_Updates</a></li>
					                	</ul>
									</div>
							        <div class="card-body">
