...
public class RepoAdminWindowsPython {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RepoAdminWindowsPython other = (RepoAdminWindowsPython) obj;
		if (c_emp_no == null) {
	...
	public String toString() {
		return "RepoAdminWindowsPython [python_idx=" + python_idx + ", python_ver_idx=" + python_ver_idx
				+ ", file_version=" + file_version + ", real_path=" + real_path + ", file_real_name=" + file_real_name
				+ ", operating_system=" + operating_system + ", description=" + description + ", file_size=" + file_size
				+ ", md5_sum=" + md5_sum + ", create_at=" + create_at + ", c_emp_no=" + c_emp_no + ", update_at="
				+ update_at + ", u_emp_no=" + u_emp_no + "]";
	}
	public RepoAdminWindowsPython(String python_idx, String python_ver_idx, String file_version, String real_path,
			String file_real_name, String operating_system, String description, String file_size, String md5_sum,
			String create_at, String c_emp_no, String update_at, String u_emp_no) {
		super();
		this.python_idx = python_idx;
		this.python_ver_idx = python_ver_idx;
		this.file_version = file_version;
